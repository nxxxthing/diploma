...
return [
    ...
    */
    ...
    'code_cipher' => env('CODE_CIPHER'),

    'validation_toastr' => true, // set this to true if you want to have toastr message with first error on validation
