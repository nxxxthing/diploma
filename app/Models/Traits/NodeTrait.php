...
trait NodeTrait
{
     ...
     * @return bool
     */
    public static function usezSoftDelete()
    {
        static $softDelete;
...
//        $this->original = array_merge($this->original, $attributes);
    ...
    protected function deleteDescendants()
    {
        ...
        $method = $this->usezSoftDelete() && $this->forceDeleting
            ? 'forceDelete'
            : 'delete';
    ...
    {
        return ! $this->usezSoftDelete() || $this->forceDeleting;
    }
